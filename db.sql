...
CREATE TABLE `ingredient` (
  ...
  `desc` text,
  `category` enum('spirit','liqueur','aromatic','bitters','citrus','sugar','garnish','mixer') DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2019-10-09 20:20:42
